...
// Timer Period: 94.815 ms
// Output Pulse(s):
// OC1A Period: 94.815 ms Width: 94.815 ms
...
while (1)
      ...
      // Place your code here
        ...
        if(error>4){ 
            ...
            outP=KP*error; //kendali integral 
            errorI=error+error_sblmI; 
            outI=KI*errorI*Tc; 
            error_sblmI=errorI;//kendali Deferensial 
            errorD=error-error_sblmD; 
            outD=(KD*errorD)/Tc;
            error_sblmD=errorD; //kontrol PID, merupakan gabungan dari kontrol P, I dan D 
